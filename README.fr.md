...
- Modele IA par defaut : `claude-opus-4-6`
- Changer de modele : `export EVOLINK_MODEL="claude-sonnet-4-5-20250929"`
- Chemin d'identifiants personnalise : `export GMAIL_SKILL_DIR="/custom/path"`
